...
try {
  ...
  console.log('Parsed audience properties:', Object.getOwnPropertyNames(parsedAudience))
  ...
  if (error.message.includes('undefined') && error.message.includes('IPLD Data Model')) {
    console.log('\nThis is the undefined encoding error we expected.')
    console.log('The issue is likely in the P256 verifier DID encoding or parsing.')
  }
}