 ...
 */
export async function createP256StorachaDelegation(aliceP256Signer, bobP256DID, storachaSpaceDID) {
 ...
 */
export async function createBridgeDelegation(storachaClient, aliceP256Signer, bobP256DID) {
