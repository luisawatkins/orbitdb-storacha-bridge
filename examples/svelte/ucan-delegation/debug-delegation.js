...
async function debugDelegation() {
  ...
  const mockBobDID = 'did:key:bob123';
  
  try {
    console.log('📊 Checking currentSpace result:', mockStorachaClient.currentSpace());
    console.log('📊 Optional chaining result:', mockStorachaClient.currentSpace()?.did());
    ...
    console.log('📊 Capabilities array:', JSON.stringify(capabilities, null, 2));
